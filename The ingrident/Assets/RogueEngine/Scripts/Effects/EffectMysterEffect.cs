...
namespace RogueEngine
{
    ...
    [CreateAssetMenu(fileName = "effect", menuName = "TcgEngine/Effect/MysterEffect", order = 10)]
    public class EffectMysterEffect : EffectData
    {
        ...
        {
            int damage = GetDamage(ability, caster, card);

...
namespace RogueEngine
{
    ...
    public static class GameAction
    {
        ...
        public const ushort ChangeState = 160;

        //Generic refresh
        public const ushort Connected = 200;
        public const ushort PlayerConnected = 202;
        public const ushort PlayerDisconnected = 204;
        ...
        public const ushort GameTest = 504;
        public const ushort MapMoved = 510;
        public const ushort MapEventStarted = 520;
        public const ushort MapRewardSelected = 530;
        public const ushort MapChoiceSelected = 532;
        public const ushort MapCardUpgraded = 540;
        public const ushort MapCardBought = 542;
        public const ushort MapItemBought = 543;
